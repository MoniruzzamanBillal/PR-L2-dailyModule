...
const gettAllStudentsFromDb = () => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield student_model_1.StudentModel.find();
    return response;
});
// !for getting  single student
const getSingleStudentFromDb = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield student_model_1.StudentModel.findOne({ id });
    return response;
});
